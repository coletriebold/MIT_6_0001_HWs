...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        string_low = []
        string_high = []
        string_low.extend(string.ascii_lowercase)
        string_high.extend(string.ascii_uppercase)
        count = 0
        for letter in string_low:
            if count+shift < 26:
                dict_to_return[letter] = string_low[count+shift]
            else:
                dict_to_return[letter] = string_low[count+shift-26]
            count += 1
        count2 = 0
        for letter in string_high:
            if count2+shift < 26:
                dict_to_return[letter] = string_high[count2+shift]
            else:
                dict_to_return[letter] = string_high[count2+shift-26]
            count2 += 1
    ...
    def apply_shift(self, shift):
        ...
        for letter in self.get_message_text():
            if letter in code_dict:
                coded_message.extend(code_dict[letter])
            else:
                coded_message.extend(letter)
...
class PlaintextMessage(Message):
    def __init__(self, text, shift):
        ...
        self.ecryption_dict = message.build_shift_dict(shift)
    ...
    def change_shift(self, shift):
        ...
        '''
        self.shift = shift
        self.ecryption_dict = Message(self.message_text).build_shift_dict(shift)
